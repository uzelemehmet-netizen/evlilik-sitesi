  ...
  useEffect(() => {
    ...
    const run = async () => {
      try {
        ...
        if (!cancelled) {
          // Sessiz fail: sadece kimlik dosyaları yine görünsün.
          setAppByUserId({});
        }
      } finally {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="mx-auto max-w-5xl px-4 py-6">
        ...
        {copiedMsg ? <div className="mt-4 rounded-xl border border-slate-200 bg-white p-3 text-slate-900 text-sm">{copiedMsg}</div> : null}
