...
export default function PwaInstallCard({ variant = 'light', flat = false }) {
  ...
  const primaryBtnClass = isDark
    ...
    : 'inline-flex items-center justify-center gap-2 rounded-md bg-emerald-600 text-white px-4 py-2 text-sm font-semibold hover:bg-emerald-700 transition disabled:opacity-60';
