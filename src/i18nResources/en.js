export default {
      ...
      matchmakingPage: {
        ...
        form: {
          ...
          labels: {
            ...
            familyApprovalStatus: 'Your family’s stance / approval status',
            ...
            communicationLanguages: 'Communication language',
            ...
            partnerTranslationApp: 'Partner can communicate using a translation app',
          ...
          placeholders: {
            ...
            familyObstacleDetails: 'Briefly explain (optional)…',
          ...
          errors: {
            ...
            photoUploadFailed: 'Photo upload failed. In local dev this is usually because the /api endpoints are not running (Cloudinary signature) or Cloudinary env is missing. Fix: run `vercel dev --listen 3000` in the project root (Vite proxies /api), or set `VITE_CLOUDINARY_CLOUD_NAME` + `VITE_CLOUDINARY_UPLOAD_PRESET` in `.env.local`. (Firebase Storage fallback can be enabled, but often hits CORS/permission issues.)',
            ...
            partnerTranslationApp: 'Please answer the partner translation app question.',
  ...
  matchmakingPanel: {
    ...
    update: {
      ...
      whatsappMessage: "I'd like to update my matchmaking application info. Application No: {{applicationId}}",
    },
    membership: {
      title: 'Membership status',
      active: 'Your membership is active.',
      inactive: 'Membership is not active. Until it is active, you cannot see full candidate details or send accept/reject decisions.',
    ...
    verification: {
      ...
      requiredBody: 'Identity verification is a trust badge. If there is a rule violation, you can file a complaint with screenshots/evidence.',
    ...
    lock: {
      ...
      body: 'After mutual acceptance, both sides choose the next step (in-site chat or contact sharing). The process is locked only when both sides choose the same option. While locked, you cannot request a new match. After contact sharing, no new matches are shown unless the match is canceled.',
      matchId: 'Match ID',
    },
    matches: {
      title: 'Your Matches',
      ...
      interaction: {
        title: 'Next step',
        lead: 'You can continue with in-site chat or share contact details with mutual approval. Chat and lock activate only when both sides choose the same option.',
        chat: 'Continue with in-site chat',
        contact: 'Share my contact details',
        chatShort: 'In-site chat',
        contactShort: 'Contact sharing',
        ...
        otherPrefersChat: '{{name}} selected in-site chat. You can continue by selecting in-site chat as well.',
        otherPrefersContact: '{{name}} selected contact sharing. You can unlock contacts by selecting contact sharing too.',
        contactUnlocked: 'Contact sharing is mutually approved. You can open contact details.',
      },
      chat: {
        title: 'In-site Chat',
      ...
      payment: {
        ...
        supportWhatsapp: 'WhatsApp support',
        supportWhatsappMessage: 'I need help with membership/payment in my matchmaking process. Match ID: {{matchId}}',
      },
    },
    intro: {
