export default {
    ...
    youtubeVisitCard: {
      eyebrow: 'YouTube',
      title: 'Visit our YouTube page to get to know us',
      body: 'To know us better, you can visit our YouTube page and channel and watch our videos.',
      cta: 'Open YouTube page',
    },
  appErrorBoundary: {
      ...
      preview: {
        ...
        notifications: {
          ...
          photos: {
            ...
            hiddenByOwner: 'This person does not want their photos to be public.',
          },
          photoAccess: {
  ...
  leadNoAuth: {
    ...
    fields: {
      ...
      weightKg: 'Weight (kg)',
      city: 'City',
      plannedLivingCountry: 'Which country would you like to live in after marriage?',
    ...
    children: {
      ...
      liveWithAfterMarriage: 'Will you live with your children after marriage?',
    },
    photo: {
  ...
  studio: {
    ...
    feedback: {
      ...
      reviewPrompt: {
        ...
        title: 'Would you rate our app?',
        body: 'Please rate our app and share your thoughts with us. Your feedback will help clear the question marks in the minds of new visitors and support us in helping them register in the system.',
        ratingLabel: 'How many stars would you give?',
        messageLabel: 'Your short comment (optional)',
        placeholder: 'What did you like, and what should we improve?',
        dismiss: 'Skip',
        submit: 'Send review',
        submitting: 'Sending…',
    ...
    pool: {
      ...
      refresh: 'Refresh',
      lastUpdated: 'The list updates only when you refresh it.',
      countHint: 'Total: {{total}} • Shown: {{shown}}',
      filters: {
        toggle: 'Filters',
        title: 'Candidate filters',
        subtitle: 'Filters only narrow what is shown in Explore.',
        reset: 'Clear filters',
        ageTitle: 'Age range',
        ageMin: 'Min age',
        ageMax: 'Max age',
        flagsTitle: 'Extra traits',
        photoOnly: 'Only candidates with photos',
        verifiedOnly: 'Only identity-verified candidates',
        maritalStatusTitle: 'Marital status',
        noResultsTitle: 'No candidates match these filters.',
        noResultsBody: 'Relax or clear the filters to show your current candidates again.',
        tutorial: {
          title: 'Explore filters are ready',
          body: 'You can now narrow the Explore list to fit what you want to review first. These filters only change what you see; they do not block anyone or save a permanent preference.',
          items: [
            'Use the age range to narrow the list quickly.',
            'Show only candidates with photos or only identity-verified candidates.',
            'Use marital status to separate the candidates that fit you better.',
          ],
          cta: 'Open filters',
          later: 'Later',
        },
      ...
      reviewCta: {
        eyebrow: 'Review',
        title: 'You can support us by rating the app',
        body: 'If you want to share your experience while browsing candidates, you can reopen the review screen here anytime.',
        button: 'Rate us',
        compact: {
          body: 'If you want to rate us later, you can reopen the review screen here.',
          button: 'Open review screen',
        },
      },
      textTranslate: {
        button: 'Translate',
      ...
      importantNotice: {
        ...
        extraSafetyTitle: 'Additional safety warning',
        extraSafetyBody: 'Keep your distance from people who say, “Come to Turkey, let’s get married here.” Do not trust such rushed, pressuring, or unclear invitations. Anyone who tries to pressure women users in this way is a serious red flag; never send messages like this, and if you see them, block and report them.',
    ...
    profileGate: {
      ...
      photoReviewBody: 'To continue, you need to upload a different profile photo that clearly identifies you. Access opens automatically after the new photo is uploaded.',
      deferredPhotoTitle: 'You cannot continue without a photo',
      deferredPhotoBody: 'You may keep your photo blurred if you want, but for transparency the system still requires at least 1 photo on your profile. Access reopens automatically as soon as you upload it.',
      deferredWhatsappTitle: 'You need to save your WhatsApp number in the system',
      deferredWhatsappBody: 'So we can contact you when needed, you are required to save your WhatsApp number in the system. Your number is never shared with anyone; it is only used when we need to reach you.',
      cta: 'Fill the form',
      photoCta: 'Upload photo',
      deferredWhatsappPrimaryCta: 'Continue',
      deferredWhatsappSaveCta: 'Save',
      deferredWhatsappSkipCta: 'Skip',
      deferredPhotoDeleteCta: 'Delete my account',
      badge: 'Unknown user',
    },
    ...
    myInfo: {
      ...
      fields: {
        ...
        liveWithChildrenAfterMarriage: 'Will live with children after marriage?',
    ...
    match: {
      ...
      status: {
        ...
        cancelled: 'Cancelled',
        deleted_user: 'No longer available',
      },
      ...
      banners: {
        ...
        removedForRulesViolation: 'This user is no longer available.',
      },
    },
    matches: {
      title: 'My Favorites',
    ...
    profile: {
      ...
      actionIntro: {
        ...
        interactionFilter: {
          ...
          body: 'You can limit who may send you a short message, add you to their people list, or start early-stage interaction with you.',
          cta: 'I read it, open',
        },
        photo: {
          title: 'Photos',
        ...
        review: {
          title: 'Rate the app',
          body: 'If you want, you can share your app experience with stars and a short comment. This is separate from the support/complaint form and can be opened whenever you want.',
          cta: 'I read it, open',
        },
        feedback: {
      ...
      photoPrivacy: {
        title: 'Photos',
        body:
          'When you blur your photos, they appear blurred in match cards and users are told that this is your privacy preference. Only people you explicitly allow can see them clearly.',
      ...
      interactionFilter: {
        title: 'Interaction filter',
        body: 'Only people who meet the rules below may message you, add you to their people list, or start early-stage interaction with you.',
        scopeHint: 'This applies to short messages, adding you to people, profile-detail requests, and early-stage like/message attempts.',
        ageTitle: 'Age range',
        ageMin: 'Min age',
        ageMax: 'Max age',
        flagsTitle: 'Extra requirements',
        requireVerified: 'Only identity-verified people',
        requirePhoto: 'Only people with a photo',
        maritalStatusTitle: 'Marital status',
        statusOn: 'The filter is active. Only people matching your criteria can start interaction with you.',
        statusOff: 'The filter is off. Anyone who passes the system rules can start interaction with you.',
        save: 'Save',
        saving: 'Saving…',
        saved: 'Interaction filter saved.',
        clear: 'Turn filter off',
        cleared: 'Interaction filter turned off.',
        tutorial: {
          title: 'New: Interaction filter',
          body: 'You can now decide who may message you or add you to their people list. This setting is checked before the other side can start interaction with you.',
          items: [
            'Limit interaction to identity-verified people.',
            'Filter out users who do not have a photo yet.',
            'Combine age and marital-status rules when you need a stricter gate.',
          ],
          cta: 'Open interaction filter',
          later: 'Later',
        },
      },
      photoManager: {
        ...
        modalIntro: 'The first slot is used as your profile photo. Update your photos any time or move another photo into the first slot. Up to 5 images.',
        primarySlotLabel: 'Profile photo',
        slotLabel: 'Photo {{index}}',
        primaryBadge: 'Profile photo',
        setPrimary: 'Use as profile photo',
        remove: 'Remove',
        empty: 'Empty',
        replace: 'Replace',
        add: 'Add',
    ...
    errors: {
      ...
      filtered: 'Your message could not be sent due to inappropriate content.',
      ...
      interactionFilterVerifiedRequired: 'This user only accepts interaction from identity-verified people.',
      interactionFilterPhotoRequired: 'This user only accepts interaction from people who have a photo.',
      interactionFilterAgeRequired: 'Your age information is missing, so you cannot pass this user\'s interaction filter.',
      interactionFilterAgeBlocked: 'You are outside the age range allowed by this user.',
      interactionFilterMaritalStatusBlocked: 'You do not match the marital-status filter selected by this user.',
  ...
  admin: {
    dashboardLite: {
      ...
      tabs: {
        ...
        kuaDocuments: 'KUA Documents',
        deletedAccounts: 'Deleted Accounts',
      },
    },
    allUsers: {
      title: 'All Users',
      subtitle: 'Lists Firebase Auth users together with their Firestore status snapshot.',
      common: {
        loading: 'Loading…',
        load: 'Load',
        loadMore: 'Load more',
      ...
      filters: {
        definedFemale: 'Defined Women ({{count}})',
        definedMale: 'Defined Men ({{count}})',
        unknown: 'Unknown Users ({{count}})',
      },
      actions: {
        markAllSystemUsers: 'Mark All as System Users',
        incompletePushDryRun: 'Push Missing Form (Dry-run)',
        incompletePushSend: 'Send Missing Form Push',
      },
      searchPlaceholder: 'Search: UC-..., email or uid',
      sort: {
        ariaLabel: 'Sort by UC code',
        userCodeDesc: 'UC: Newest → Oldest',
        userCodeAsc: 'UC: Oldest → Newest',
      },
      counts: {
        unknown: 'Unknown users: {{count}}',
        definedMale: 'Defined male users: {{count}}',
        definedFemale: 'Defined female users: {{count}}',
      },
      selected: {
        title: 'Selected User',
        formPhotosButton: 'Form and Photos',
        formPhotosTitle: 'Show the selected user\'s form, application, and photo details',
      },
      badges: {
        membership: 'Membership',
        ...
        payment: 'Payment',
        photoRestricted: 'Photo restricted',
        photoClear: 'No photo restriction',
      },
      states: {
        active: 'Active',
        passive: 'Passive',
      ...
      confirms: {
        sendIncompletePush: 'A one-time notification will be sent to users with push enabled and an incomplete form. Continue?',
        sendPhotoWarning: 'Send a misleading / unrelated photo warning to this user? They will not be able to use the app until they upload their own photo.',
        clearPhotoRestriction: 'Remove the photo restriction for this user?',
      },
      modal: {
        photoWarningsTitle: 'Photo Warnings',
        sendPhotoWarning: 'Send Misleading Photo Warning',
        clearPhotoRestriction: 'Clear Photo Restriction',
        photoWarningHint: 'The system removes the restriction automatically when the user uploads a new and different photo.',
        blockTitle: 'Block',
        blockReasonPlaceholder: 'Block reason (optional)',
        blockAccount: 'Block Account',
        unblockAccount: 'Remove Block',
        blockHint: 'Note: Blocking also disables the Auth account.',
        deleteTitle: 'Delete Account (irreversible)',
        deleteConfirm: 'Yes, I want to delete it irreversibly',
        deleteButton: 'Delete Account',
        deleteHint: 'Confirmation format:',
      },
    },
    userTools: {
      prompts: {
  ...
  matchmakingHub: {
    ...
    cards: {
      private: {
        ...
        deferredPhotoBody: 'Uploading a photo is required. Later, if you want, you can hide it from the Photos section in the Actions menu; however, the system still requires at least 1 photo on your profile. Access reopens automatically as soon as you upload it.',
  ...
  youtubePage: {
    ...
    cta: {
      ...
      visit: "Visit channel",
      installPage: 'Go to app install page',
    },
  },
  ...
  publicReviews: {
    ...
    title: 'Some users describe the experience like this',
    body: 'Ratings sent from inside the app appear here after admin approval with profile photo, user code, name, and city details.',
    featured: 'Featured',
    locationFallback: 'Location hidden',
    nameFallback: 'Anonymous',
    adminReplyLabel: 'uniqah.com replied',
    profilePhotoAlt: '{{name}} profile photo',
    showMore: 'Click to see more',
    showLess: 'Show less',
    averageSummary: 'Shared average {{average}} / 5 across {{count}} rated reviews',
    starOnlyFallback: 'This user left a star rating only.',
    translate: 'Translate',
    showOriginal: 'Show original',
    translating: 'Translating…',
    translationError: 'Translation could not be loaded. Please try again.',
  },
  ...
  matchmakingPage: {
    ...
    form: {
      ...
      draftResume: {
        title: 'Your draft has been restored',
        body: 'This record is not a submitted application yet. To use the system, complete your photo and press Submit Application on the last step.',
        photoMissing: 'There is no stored photo on the server. Photos that were only selected on the device and never submitted cannot be restored after the app is deleted; please add the photo again and submit the application.',
      },
      applicationIdLabel: 'Application ID',
      deferCta: 'Fill later',
      ...
      contactNumberNote: 'Your contact number is not shared with anyone. You can leave it empty on the first submit; the system asks you to save it later when needed.',
      inviteCodeHelp:
      ...
      labels: {
        ...
        childrenCount: 'Children count',
        liveWithChildrenAfterMarriage: 'Will your children live with you after marriage?',
      ...
      errors: {
        ...
        photoUploadDeferred:
          'Your application was saved, but the photos could not be uploaded. The photo manager has been opened on your profile; please upload the photos again.',
        ...
        liveWithChildrenAfterMarriage: 'Please select whether your children will live with you after marriage.',
