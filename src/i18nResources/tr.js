export default {
  ...
  matchmakingPage: {
    ...
    form: {
      ...
      labels: {
        ...
        familyApprovalStatus: 'Ailenizin evliliğe yaklaşımı / onay durumu',
        ...
        translationApp: 'Çeviri uygulaması ile iletişim kurabilirim',
        ...
        partnerTranslationApp: 'Aradığınız kişi çeviri uygulaması ile iletişim kurabilir',
      ...
      placeholders: {
        ...
        familyObstacleDetails: 'Kısaca açıklayın (opsiyonel)…',
      ...
      errors: {
        ...
        partnerTranslationApp: 'Lütfen aradığınız kişi için çeviri uygulaması sorusunu yanıtlayın.',
  ...
  matchmakingPanel: {
    ...
    account: {
      title: 'Hesap',
      emailLabel: 'Kullanıcı adı (e-posta)',
      nameLabel: 'Ad',
    },
    application: {
      title: 'Evlilik Eşleştirme Başvurusu',
    ...
    verification: {
      ...
      requiredBody: 'Kimlik doğrulama bir güven rozetidir. Kurallara aykırı davranışlarda kanıtla şikayet oluşturabilirsiniz.',
      unverifiedTitle: 'Kimlik doğrulama (rozet)',
      unverifiedBodyMale: 'Kimlik doğrulama bir güven rozetidir. Erkek kullanıcılar için aksiyon açma kriteri üyelik/paket durumudur.',
      unverifiedBodyFemale: 'Kimlik doğrulama bir güven rozetidir ve kadın kullanıcılar için üyelik olmadan da işlemleri açabilir.',
    ...
    lock: {
      ...
      body: 'Kilit, karşılıklı onaydan sonra iki taraf da panelde aynı “2. adım”ı seçtiğinde (site içi konuşma / iletişim paylaşımı) devreye girer. Kilitliyken yeni aday talep edemezsiniz. Eşleşmeyi sonlandırmak veya uyuşmazlık bildirmek için destek hattına yazın.',
      matchId: 'Eşleşme ID',
    },
    matches: {
      ...
      interaction: {
        ...
        lead: 'İsterseniz site içinden konuşabilir veya karşılıklı onayla iletişim bilgilerini paylaşabilirsiniz. Sohbet ve kilit, aynı seçenek iki tarafta da seçilince açılır.',
        chat: 'Site içi konuşalım',
        contact: 'İletişim bilgilerimi ver',
        chatShort: 'Site içi konuşma',
        contactShort: 'İletişim paylaşımı',
        ...
        otherPrefersChat: '{{name}} site içi konuşmayı işaretledi. Bu kullanıcıyla site içi konuşma seçeneğiyle devam edebilirsiniz.',
        otherPrefersContact: '{{name}} iletişim paylaşımını işaretledi. İsterseniz siz de iletişim paylaşımını seçerek iletişimleri açabilirsiniz.',
        contactUnlocked: 'İletişim paylaşımı karşılıklı onaylandı. İletişim bilgilerini açabilirsiniz.',
      },
      chat: {
      ...
      candidate: {
        fallbackName: 'Aday',
        verifiedBadge: 'Kimliği doğrulanmış',
        matchedProfile: 'Eşleştiğiniz profil',
        score: 'Skor',
      ...
      payment: {
        ...
        supportWhatsappMessage: 'Eşleşme sürecimde üyelik/ödeme ile ilgili destek istiyorum. Eşleşme ID: {{matchId}}',
      },
    },
    intro: {
