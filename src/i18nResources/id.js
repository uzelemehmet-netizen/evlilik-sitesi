...
const overrides = {
  ...
  about: {
    ...
    brand: {
      ...
      p2:
        'MoonStar Global Indonesia dibangun oleh wirausahawan Turki yang tinggal di Indonesia untuk memahami kebutuhan tamu Turki secara langsung dan menyelesaikannya di lapangan.',
      cards: {
