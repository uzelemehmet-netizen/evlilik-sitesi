...
const overrides = {
  ...
  footer: {
    ...
    sections: {
      ...
      localDevButton: 'Pemasangan lokal tidak aktif',
      localDevTitle: 'Ini adalah lingkungan pengembangan lokal',
      localDevBody: 'Di server pengembangan lokal Vite, prompt pemasangan PWA native tidak akan muncul, baik di Windows maupun macOS. Dalam proyek ini service worker hanya didaftarkan pada build production. Uji perilaku pemasangan yang sebenarnya di environment production/preview HTTPS.',
      localDevNotInstallable: 'Prompt pemasangan PWA native tidak aktif di lingkungan pengembangan lokal ini. Gunakan build production atau preview HTTPS untuk menguji pemasangan.',
  ...
  admin: {
    dashboardLite: {
      ...
      tabs: {
        ...
        kuaDocuments: 'Dokumen KUA',
        deletedAccounts: 'Akun terhapus',
      },
    },
  ...
  studio: {
    ...
    pool: {
      ...
      refresh: 'Muat ulang',
      lastUpdated: 'Daftar hanya diperbarui saat Anda menekan muat ulang.',
      countHint: 'Total: {{total}} • Ditampilkan: {{shown}}',
      filters: {
        toggle: 'Filter',
        title: 'Filter kandidat',
        subtitle: 'Filter hanya mempersempit tampilan di daftar Jelajahi.',
        reset: 'Hapus filter',
        ageTitle: 'Rentang usia',
        ageMin: 'Usia min',
        ageMax: 'Usia maks',
        flagsTitle: 'Fitur tambahan',
        photoOnly: 'Hanya kandidat dengan foto',
        verifiedOnly: 'Hanya kandidat dengan identitas terverifikasi',
        maritalStatusTitle: 'Status pernikahan',
        noResultsTitle: 'Tidak ada kandidat yang cocok dengan filter ini.',
        noResultsBody: 'Longgarkan atau hapus filter untuk menampilkan kandidat yang ada lagi.',
        tutorial: {
          title: 'Filter Jelajahi siap dipakai',
          body: 'Sekarang Anda bisa mempersempit daftar Jelajahi sesuai kandidat yang ingin Anda lihat lebih dulu. Filter ini hanya mengubah tampilan; tidak memblokir siapa pun dan tidak menyimpan preferensi permanen.',
          items: [
            'Gunakan rentang usia untuk mempersempit daftar dengan cepat.',
            'Tampilkan hanya kandidat yang punya foto atau hanya yang identitasnya terverifikasi.',
            'Gunakan status pernikahan untuk memisahkan kandidat yang lebih sesuai.',
          ],
          cta: 'Buka filter',
          later: 'Nanti',
        },
      ...
      reviewCta: {
        eyebrow: 'Ulasan',
        title: 'Anda bisa membantu kami dengan memberi ulasan aplikasi',
        body: 'Saat meninjau kandidat, Anda bisa membuka lagi layar ulasan dari sini kapan saja untuk membagikan pengalaman Anda.',
        button: 'Beri ulasan',
        compact: {
          body: 'Jika ingin memberi ulasan nanti, Anda bisa membuka lagi layar ulasan dari sini.',
          button: 'Buka layar ulasan',
        },
      },
      textTranslate: {
        button: 'Terjemahkan',
        showOriginal: 'Tampilkan asli',
        showTranslated: 'Tampilkan terjemahan',
        translating: 'Sedang menerjemahkan…',
        done: 'Sudah diterjemahkan',
      ...
      importantNotice: {
        ...
        extraSafetyTitle: 'Peringatan keamanan tambahan',
        extraSafetyBody: 'Jauhi orang yang berkata, “Datang saja ke Turki, kita menikah di sini.” Jangan percaya pada ajakan yang terburu-buru, menekan, atau niatnya tidak jelas seperti ini. Siapa pun yang mencoba menekan pengguna perempuan dengan cara seperti ini adalah tanda bahaya serius; jangan pernah mengirim pesan seperti itu, dan jika Anda melihatnya, blokir lalu laporkan.',
    ...
    waitingNote: {
      ...
      body:
        'Kami sedang mencari pasangan yang sesuai dengan informasi profil dan kriteria Anda. Profil yang cocok akan tampil di tab <explore>Jelajah</explore>. Instal aplikasi dan aktifkan notifikasi agar mendapat pemberitahuan secara instan.',
    },
    ...
    profileGate: {
      ...
      photoReviewBody: 'Untuk melanjutkan, Anda perlu mengunggah foto profil lain yang memperlihatkan diri Anda dengan jelas. Akses akan terbuka otomatis setelah foto baru diunggah.',
      deferredPhotoTitle: 'Anda tidak bisa lanjut tanpa foto',
      deferredPhotoBody: 'Anda boleh menyamarkan foto jika mau, tetapi demi transparansi sistem tetap mewajibkan minimal 1 foto di profil Anda. Akses akan terbuka otomatis begitu foto diunggah.',
      deferredWhatsappTitle: 'Anda perlu menyimpan nomor WhatsApp di sistem',
      deferredWhatsappBody: 'Agar kami bisa menghubungi Anda saat diperlukan, nomor WhatsApp Anda harus disimpan di sistem. Nomor ini tidak pernah dibagikan ke siapa pun; hanya dipakai saat kami perlu menghubungi Anda.',
      cta: 'Isi formulir profil',
      photoCta: 'Unggah foto',
      deferredWhatsappPrimaryCta: 'Lanjut',
      deferredWhatsappSaveCta: 'Simpan',
      deferredWhatsappSkipCta: 'Lewati',
      deferredPhotoDeleteCta: 'Hapus akun saya',
    ...
    myInfo: {
      ...
      fields: {
        ...
        liveWithChildrenAfterMarriage: 'Akan tinggal bersama anak setelah menikah?',
    ...
    match: {
      ...
      status: {
        ...
        deleted_user: 'Tidak lagi tersedia',
      },
      ...
      banners: {
        ...
        removedForRulesViolation: 'Pengguna ini tidak lagi tersedia.',
      },
    },
    ...
    profile: {
      ...
      actionIntro: {
        ...
        interactionFilter: {
          title: 'Filter interaksi',
          body: 'Anda dapat membatasi siapa yang boleh mengirim pesan singkat, menambahkan Anda ke daftar orang mereka, atau memulai interaksi tahap awal dengan Anda.',
          cta: 'Saya sudah baca, buka',
        },
        photo: {
          title: 'Foto',
      ...
      interactionFilter: {
        title: 'Filter interaksi',
        body: 'Hanya orang yang memenuhi aturan di bawah ini yang dapat mengirim pesan, menambahkan Anda ke daftar mereka, atau memulai interaksi tahap awal dengan Anda.',
        scopeHint: 'Ini berlaku untuk pesan singkat, menambahkan ke daftar orang, permintaan detail profil, serta percobaan suka/pesan tahap awal.',
        ageTitle: 'Rentang usia',
        ageMin: 'Usia min',
        ageMax: 'Usia maks',
        flagsTitle: 'Syarat tambahan',
        requireVerified: 'Hanya orang dengan identitas terverifikasi',
        requirePhoto: 'Hanya orang yang punya foto',
        maritalStatusTitle: 'Status pernikahan',
        statusOn: 'Filter aktif. Hanya orang yang sesuai kriteria Anda yang dapat memulai interaksi.',
        statusOff: 'Filter nonaktif. Siapa pun yang lolos aturan sistem dapat memulai interaksi.',
        save: 'Simpan',
        saving: 'Menyimpan…',
        saved: 'Filter interaksi tersimpan.',
        clear: 'Matikan filter',
        cleared: 'Filter interaksi dimatikan.',
        tutorial: {
          title: 'Baru: Filter interaksi',
          body: 'Sekarang Anda bisa menentukan siapa yang boleh mengirim pesan atau menambahkan Anda ke daftar mereka. Pengaturan ini diperiksa sebelum pihak lain bisa memulai interaksi dengan Anda.',
          items: [
            'Batasi interaksi hanya untuk orang dengan identitas terverifikasi.',
            'Saring pengguna yang belum memiliki foto.',
            'Gabungkan aturan usia dan status pernikahan untuk pintu masuk yang lebih ketat.',
          ],
          cta: 'Buka filter interaksi',
          later: 'Nanti',
        },
      },
      photoManager: {
    ...
    errors: {
      ...
      interactionFilterVerifiedRequired: 'Pengguna ini hanya menerima interaksi dari orang yang identitasnya terverifikasi.',
      interactionFilterPhotoRequired: 'Pengguna ini hanya menerima interaksi dari orang yang memiliki foto.',
      interactionFilterAgeRequired: 'Data usia Anda belum ada, jadi Anda tidak bisa melewati filter interaksi pengguna ini.',
      interactionFilterAgeBlocked: 'Usia Anda berada di luar rentang yang diizinkan pengguna ini.',
      interactionFilterMaritalStatusBlocked: 'Anda tidak cocok dengan filter status pernikahan yang dipilih pengguna ini.',
  ...
  matchmakingPage: {
    ...
    form: {
      ...
      labels: {
        ...
        liveWithChildrenAfterMarriage: 'Apakah anak Anda akan tinggal bersama Anda setelah menikah?',
      ...
      errors: {
        ...
        liveWithChildrenAfterMarriage: 'Silakan pilih apakah anak Anda akan tinggal bersama Anda setelah menikah.',
  ...
  publicReviews: {
    ...
    title: 'Beberapa pengguna menggambarkan pengalaman mereka seperti ini',
    body: 'Penilaian yang dikirim dari dalam aplikasi akan tampil di sini setelah disetujui admin, bersama foto profil, kode pengguna, nama, dan kota.',
    featured: 'Unggulan',
    locationFallback: 'Lokasi disembunyikan',
    nameFallback: 'Anonim',
    adminReplyLabel: 'uniqah.com membalas',
    profilePhotoAlt: 'Foto profil {{name}}',
    showMore: 'Klik untuk melihat lebih banyak',
    showLess: 'Tampilkan lebih sedikit',
    averageSummary: 'Rata-rata bersama {{average}} / 5 dari {{count}} ulasan bernilai',
    starOnlyFallback: 'Pengguna ini hanya memberi rating bintang.',
    translate: 'Terjemahkan',
    showOriginal: 'Tampilkan asli',
    translating: 'Menerjemahkan…',
    translationError: 'Terjemahan tidak dapat dimuat. Silakan coba lagi.',
  },
  ...
  weddingPage: {
    ...
    mobileDocuments: {
      ...
      trRequirements: {
        ...
        steps: [
          {
            title: '1. KBRI Ankara: izin menikah (CNI)',
          ...
          {
            title: '2. Turki: dokumen untuk kantor nikah (Belediye Evlendirme Dairesi)',
            ...
            notes: [
              ...
              'Kesalahan umum yang membuat proses jadi sulit',
    ...
    documents: {
      ...
      personalDifferences: {
        title: 'Perbedaan kondisi pribadi',
        p1:
